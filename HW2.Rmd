...
$E(Y|P,rincome)=2+\beta^* P+3 rincome$
...
$\quad E(Y|P_z,rincome)$

$=E(2+\beta^* P_z+3 rincome+\tilde{\epsilon}+\delta |P_z,rincome)$
...
$\quad E(y_i|\tilde{x}_i,w_i)$

$=E(\beta^* (\tilde{x}-\epsilon_i)+\gamma w_i+y_{-x,-w,i}|x_i,w_i)$

$=\beta^* \tilde{x}-\beta^*E(\epsilon_i|\tilde{x}_i,w_i)+\gamma w_i$<br/><br/>

if $E(\epsilon_i|\tilde{x}_i,w_i)=0$

$=\beta^*\tilde{x}+\gamma w_i+y_{-x,-w,i}$
...
ANS:
$\quad E(y_i|x_i,\tilde{w}_i)$

$=E(\beta^* x+\gamma (\tilde{w}-\epsilon_i)+y_{-x,-w,i}|x_i,\tilde{w}_i)$

$=\beta^* x+\gamma E(\tilde{w}-\epsilon_i|x_i,\tilde{w}_i)+y_{-x,-w,i}$

$=\beta^* x+\gamma \tilde{w}-\gamma E(\epsilon_i|x_i,\tilde{w}_i)+y_{-x,-w,i}$<br/><br/>

if $E(\epsilon_i|x_i,\tilde{w}_i)=0$
