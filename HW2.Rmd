...
$E(Y|P_z,rincome)=E(2+\beta^* P_z+3 rincome+\tilde{\epsilon}+\delta |P_z,rincome)$

$\quad \quad \quad \quad \quad \quad \quad \quad =2+\beta^* P+3 rincome$
...
數不會是$\beta^*$.
ANS:
$\quad E(Y|P,rincome,Z)=2+\beta^* P+3 rincome+E(\tilde{\epsilon}|P,rincome,Z)$
