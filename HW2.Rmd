...
$\quad E(Y|P,rincome)=2+\beta^* P+3E(rincome|P,rincome)+E(\tilde{\epsilon} |P,rincome)$
...
$\quad E(Y|P)=2+\beta^*P+3(0.5+P)+0.5+2P=(5+\beta^*)P+4$

$\quad E(Y|P,rincome)=2+\beta^* P+3 rincome+E(\tilde{\epsilon} |P,rincome)$
